...
async function callAddKycVersionOnContract(
  ...
  console.log(
    `[Bank A - toChain - callAddKycVersion] Tx sent for clientId ${clientId}, hash: ${tx.hash}. Waiting for mining...`
  );
...
async function syncBundleWithCustomerPortal(
  ...
  ktpDataUriForBundle,
  kycDataUriForBundle,
  callingBankIdentifier // e.g., "BANK_A"
) {
  ...
  console.log(
    `[BANK A - toChain - syncBundleWithCP] Calling CP (${customerPortalSyncUrl}) for user ${userId}.`
  );
  ...
  try {
    ...
    console.log(
      `[BANK A - toChain - syncBundleWithCP] Received new bundle from CP for user ${userId}.`
    );
    ...
    console.log(
      `[BANK A - toChain - syncBundleWithCP] Successfully updated bankb_portal.user_profiles for user_id ${userId}.`
    );
    // -------------------------------------------------------------------------
